    ...
    public partial class Form1 : Form
    {
        ...
        private void parsingForStatus(string bufferdata, int meriam)
        {
            ...
            if (bufferdata.Length > 0)
            {
                ...
                if (thereisdata)
                {
                        //Seharusnya idx-1 sudah berisi '*'

                    ///GATAU GABISA NI KODINGAN CCD
                        //if ((bufferdata[idx] == 'C') && (bufferdata[idx + 1] == 'P') && (bufferdata[idx+2] == ',')) 
                        //{

                        //    //if (bufferdata[idx + 3] == 0)
                        //    //{
                        //    //    if (bufferdata[idx + 4] == 1)
                        //    //    {
                        //    //        string status = "ON";
                        //    //        gunStatus(meriam, status);

                        //    //    }
                        //    //    else if (bufferdata[idx + 4] == 2)
                        //    //    {
                        //    //        string status = "LOCAL";
                        //    //        gunStatus(meriam, status);
                        //    //    }
                        //    //    else if (bufferdata[idx + 4] == 3)
                        //    //    {
                        //    //        string status = "REMOTE";
                        //    //        gunStatus(meriam, status);
                        //    //    }
                        //    //    else if (bufferdata[idx + 4] == 9)
                        //    //    {
        ...
        private void openServerPorts()
        {
            ...
            ipAddressServerBind = IPAddress.Parse("192.168.1.33"); ///< IP Address of FCS
